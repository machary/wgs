 ...
 */
// untuk detail error page , ganti environment ke 'development'
// menampilkan halaman error page untuk keperluan demo  , ganti environment ke 'production'
...
define('UPLOAD_PATH', realpath(dirname(__FILE__) . '/../public/upload/images'));

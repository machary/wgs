...
//jQuery UI elements (more info can be found at http://jqueryui.com/demos/)
    ...
    $("a.toggle").click(function(){
        $(this).toggleClass("toggle_closed").next().slideToggle(100);
    ...
    $( ".datepicker" ).datepicker({ dateFormat: 'yy-mm-dd', changeMonth: true, changeYear: true, yearRange: 'c-10:c' });; // the time format which will be input to the datepicker field upon selection. more info on formatting here: http://docs.jquery.com/UI/Datepicker/formatDate
...
//		});
    ...
    //This configures the List View style )
    $('#list').listNav();

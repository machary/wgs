<?php
class Peta_MusuhController extends App_CrudController
{
    protected $_kogas = '';
    protected $_cbTableName = 'latihan.intelijen_musuh_cb';
    protected $_cbCrudClass = 'Peta_Model_DbTable_Cb';
    protected $_ruteClass = array(
        'laut' => 'Peta_Model_DbTable_Laut',
        'udara' => 'Peta_Model_DbTable_Udara',
    );
    protected $_perbandinganClass = 'Ops_Model_Musuh_Perbandingan';
    ...
    protected function _ruteIndex($jenis)
    {
        if (!isset($this->_ruteClass[$jenis])) {
            return $this->_redirector->gotoSimple('index' , 'rencana.intelijen.musuh');
        }
        $this->getHelper('viewRenderer')->setViewScriptPathSpec('musuh/rute-index.phtml');
    ...
    protected function _ruteEdit($jenis)
    {
        ...
        $this->getHelper('viewRenderer')->setViewScriptPathSpec('musuh/rute-edit.phtml');
    ...
    protected function _ruteSimulasi($jenis)
    {
        ...
        $this->getHelper('viewRenderer')->setViewScriptPathSpec('musuh/rute-simulasi.phtml');
    ...
    protected function _ruteSimulasiSemua($jenis)
    {
        ...
        $this->getHelper('viewRenderer')->setViewScriptPathSpec('musuh/rute-simulasi-semua.phtml');

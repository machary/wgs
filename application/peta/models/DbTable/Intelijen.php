<?php
class Peta_Model_DbTable_Intelijen extends Zend_Db_Table_Abstract
{
    protected $_name = 'intelijen_poly';
    protected $_tableName = 'intelijen_poly';
    ...
    public function insertmatra($post, $idTaktis, $jumKekuatan, $matra, $user, $keterangan)
    {
        ...
        switch($matra){
            case 'Darat':
                $data = array(
                    'tanggal'           => $list->ConvertDateStringIntel($post['tanggal']),
                    'waktu'             => $post['waktu'],
                    'negara'            => $post['negara'],
                    'matra'             => $matra,
    ...
    public function getalldataintelijen($limit, $offset, $sortColumn, $order, $filter, $search, $count)
    {
        $query = $this->select()->setIntegrityCheck(false)
    ...
    public function getLonlat( $matra = null )
    {
        ...
        $query->where('poly."id_login" = ?', $identity->id);
    ...
    public function getIntelijen($id)
    {
        $query = $this->select()->setIntegrityCheck(false)
                    ->from(array('intel' => $this->_tableName))
    ...
    public function updateIntelijen($post, $idTaktis, $jumKekuatan, $id, $matra, $keteranganArr)
    {
        $list = new Cms_Model_DbTable_List();
    ...
    public function deleteintelijen($id)
    {
        $this->delete("id = '".$id."'");
    }
    ...
    public function tablePergerakan(){
        $table = new Zend_Db_Table('intelijen_pergerakan');
        $table->_cols = array(
            'id'                    => 'id',

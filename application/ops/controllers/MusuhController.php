<?php
/** 
 * Generic Controller for Pergerakan Musuh
 *
 * @author Febi
 */
 
class Ops_MusuhController extends App_CrudController
{
    protected $_kogas = '';
   	protected $_cbTableName = 'ops.musuh_cb';
   	protected $_cbCrudClass = 'Ops_Model_Musuh_Cb';
...
//		$this->view->kogas = $this->_kogas;
	...
	protected function _ruteIndex($jenis)
	{
		if (!isset($this->_ruteClass[$jenis])) {
			return $this->_redirector->gotoSimple('index' , 'rencana.operasi.musuh');
		}

<?php
class Ops_Form_Situasi_UdaraForm extends Zend_Form
{
    public function __construct($option = null)
    {
	    ...
	    $negara->setAttrib('label-name', "Judul Kesatuan")
		    ->setAttrib('id', 'negara')
		    ->setRequired(true)
		    ->removeDecorator('label');
        ...
        $redirect ->setAttrib('title','ops/situasi');
        $this->addElement($redirect);

        $this->setMethod('post');
        $this->setAttrib('id', 'frmUdara');
        $this->setLegend('Form Situtasi Udara');

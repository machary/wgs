<?php
/**
 * Kogasgablinud CRUD CB
 *
 * @author Kanwil
 */
 
class Ops_Model_Gablinud_Cb extends Ops_Model_Cb
{
	protected $_tableName = 'gablinud_cb';

    public function getallps($id)
    {
        $table = new Zend_Db_Table('ops.gablinud_cb');

        $query = $table->select()->setIntegrityCheck(false)
            ->from(array('prod' => 'ops.gablinud_cb'))

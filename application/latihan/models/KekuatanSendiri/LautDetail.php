<?php
/**
 * Model untuk Kekuatan Sendiri - Laut Detail
 *
 * @author Kanwil
 */

class Latihan_Model_KekuatanSendiri_LautDetail
{
	protected $_parent_id;
	protected $_data;
	protected $_tableName = 'latihan.kekuatan_sendiri_laut_detail';
	...
	public function __construct( $parent_id)
	{
		...
		$dbTable = new Zend_Db_Table('latihan.kekuatan_sendiri_laut_detail');
	}
	...
	public function all()
	{
		...
		{
			$table = $this->table();
			$query = $table->select()->setIntegrityCheck(false)->from(array('ud' => 'latihan.kekuatan_sendiri_laut_detail'))

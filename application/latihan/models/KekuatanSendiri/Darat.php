<?php
/**
 * Model untuk Kekuatan Sendiri - Darat
 *
 * @author Tajhul Faijin
 */
 
class Latihan_Model_KekuatanSendiri_Darat
{
	protected $_skenario;
    protected $_data;
	...
	{
		return new Zend_Db_Table('latihan.kekuatan_sendiri_darat');
	}
	
    public function tableDetail()
   	{
   		return new Zend_Db_Table('latihan.kekuatan_sendiri_darat_detail');
   	}
	/**

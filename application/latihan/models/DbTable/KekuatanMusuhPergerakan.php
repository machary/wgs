<?php
class Latihan_Model_DbTable_KekuatanMusuhPergerakan extends Zend_Db_Table_Abstract
{
	protected $_name = 'latihan.kekuatan_musuh_pergerakan';
	protected $_tableName = 'latihan.kekuatan_musuh_pergerakan';
	...
	public function updatepergerakan($tanggal, $waktu, $idSimTak, $point, $rotate, $size, $id, $keterangan)
	{
		...
		$this->update($data, 'latihan."kekuatan_musuh_pergerakan"."id" = '."'".$id."'");
	}

	public function deletepergerakan($id_skenario)
	{
		$this->delete('latihan."kekuatan_musuh_pergerakan"."id_skenario" = '."'".$id_skenario."'");
	}
}
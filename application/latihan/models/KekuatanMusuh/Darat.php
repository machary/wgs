<?php
/**
 * Model untuk Kekuatan Musuh- Darat
 *
 * @author irfan.muslim@sangkuriang.co.id
 */
 
class Latihan_Model_KekuatanMusuh_Darat
{
	protected $_skenario;
    protected $_data;
	...
	{
		return new Zend_Db_Table('latihan.kekuatan_musuh_darat');
	}
	
    public function tableDetail()
   	{
   		return new Zend_Db_Table('latihan.kekuatan_musuh_darat_detail');
   	}
	/**

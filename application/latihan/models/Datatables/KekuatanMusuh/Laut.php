<?php
/**
 * Datatables untuk CRUD Kekuatan Musuh
 * @author irfan.muslim@sangkuriang.co.id
 */
 
class Latihan_Model_Datatables_KekuatanMusuh_Laut extends App_Datatables
{
	// main table name used
	public $tname = 'latihan.kekuatan_musuh_laut';
...
//			'bandara_id',
	...
	public function retrieveData()
	{
		...
		foreach ($raw as $row) {
			...
			$t[] = '
				<a href="'.$hUrl->url(array('action'=>'laut.edit', 'id'=>$id )).'">Ubah</a> |
				<a href="'.$hUrl->url(array('action'=>'laut.del', 'id'=>$id)).'" onclick="return confirm(\'Anda yakin?\')">Hapus</a>
			';
			$result[] = $t;
		}
		return $result;
	...
	{
		$table = new Zend_Db_Table('latihan.kekuatan_musuh_laut_detail');
		$query = $table->select()->setIntegrityCheck(false)
			->from(array('ksd' => 'latihan.kekuatan_musuh_laut_detail'))

...
class Latihan_Model_Datatables_KekuatanMusuh_Darat extends App_Datatables
{
	// main table name used
	public $tname = 'latihan.kekuatan_musuh_darat';
...
//			'bandara_id',
	...
	{
		$table = new Zend_Db_Table('latihan.kekuatan_musuh_darat_detail');
		$query = $table->select()->setIntegrityCheck(false)
			->from(array('ksd' => 'latihan.kekuatan_musuh_darat_detail'))

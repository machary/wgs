...
class Latihan_Model_Datatables_KekuatanMusuh_Udara extends App_Datatables
{
	// main table name used
	public $tname = 'latihan.kekuatan_musuh_udara';
...
//			'bandara_id',
	...
	{
		$table = new Zend_Db_Table('latihan.kekuatan_musuh_udara_detail');
		$query = $table->select()->setIntegrityCheck(false)

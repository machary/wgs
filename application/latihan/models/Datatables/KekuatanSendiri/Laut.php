...
class Latihan_Model_Datatables_KekuatanSendiri_Laut extends App_Datatables
{
	// main table name used
	public $tname = 'latihan.kekuatan_sendiri_laut';
...
//			'bandara_id',
	...
	{
		$table = new Zend_Db_Table('latihan.kekuatan_sendiri_laut_detail');
		$query = $table->select()->setIntegrityCheck(false)
			->from(array('ksd' => 'latihan.kekuatan_sendiri_laut_detail'))

<?php
/**
 * Model untuk table Data KRI Detail Motor Listrik
 * @author tajhul.faijin@sangkuriang.co.id
 */
 
class Cms_Model_DataKriDetailListrikCrud extends App_Model_Crud
{
	protected $_primary = 'id';
	protected $_tableSchema = 'master';
	protected $_tableName = 'data_pokok_kri_detail_listrik';

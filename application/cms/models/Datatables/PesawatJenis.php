<?php
/**
 * Datatables untuk CRUD PesawatJenis
 * @author irfan.muslim@sangkuriang.co.id
 */
 
class Cms_Model_Datatables_PesawatJenis extends App_Datatables
{
	...
	{
		$table = new Zend_Db_Table('master.pesawat_jenis');
...
//		return $this->getTotalRecords();
	...
	public function retrieveData()
	{
		...
		$query = $table->select()->setIntegrityCheck(false)
			->from(array('master.pesawat_jenis'), array(
				'pesawat_jenis_id', // id
				'nama',
				'model',
				'engine',

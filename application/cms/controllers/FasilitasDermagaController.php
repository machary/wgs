<?php
/**
 * CRUD untuk Fasilitas Dermaga
 *
 * @author Kanwil
 */
 
class Cms_FasilitasDermagaController extends App_CrudController
{
	...
	public function dataapiAction()
	{
		...
		/**/
		$dt = new Cms_Model_Datatables_FasDermaga($this->_request->getParams());
		echo $dt->result();
		/**/
	}
	...
	{
		$this->_add(null, 'index', 'Cms_Model_FasDermaga');
	}
	
	public function editAction()
	{
		$this->_edit(null, 'index', 'Cms_Model_FasDermaga');
	}
	
	public function delAction()
	{
		$this->_del(null, 'index', 'Cms_Model_FasDermaga');
	}

	//@author irfan.muslim@sangkuriang.co.id
	public function viewAction()
	{
		$obj = new Cms_Model_FasDermaga(null,$this->_request->getParam('id'));
		$this->view->obj = $obj;
	}
	...
	public function importAction()
	{
		...
		*/
		$importer = new Cms_Model_Import_Excel('master.fasilitas_dermaga', array(
			'idpangkalan', 'nama_dermaga', 'konstruksi',
			'panjang',
			'lebar',
			'puansandar',
			'kondisi',
		...
		*/
		$model = new Cms_Model_FasDermaga();

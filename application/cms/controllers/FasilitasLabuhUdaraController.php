<?php
/**
 * CRUD untuk Fasilitas Jaringan Listrik
 *
 * @author Kanwil
 */

class Cms_FasilitasLabuhUdaraController extends App_CrudController
{
    ...
    public function dataapiAction()
    {
        ...
        /**/
        $dt = new Cms_Model_Datatables_FasilitasLabuhUdara($this->_request->getParams());
        echo $dt->result();
        /**/
    }
    ...
    {
        $this->_add(null, 'index', 'Cms_Model_FasilitasLabuhUdara');
    }

    public function editAction()
    {
        $this->_edit(null, 'index', 'Cms_Model_FasilitasLabuhUdara');
    }

    public function delAction()
    {
        $this->_del(null, 'index', 'Cms_Model_FasilitasLabuhUdara');
    }
	...
	{
		$obj = new Cms_Model_FasilitasLabuhUdara(null,$this->_request->getParam('id'));
		$this->view->obj = $obj;
	}
	...
	public function importAction()
	{
		...
		*/
		$importer = new Cms_Model_Import_Excel('master.fasilitas_labuh_udara', array(
			'idpangkalan', 'nama_item', 'jenis_konstruksi',
			'luas',
			'panjang',
			'lebar',
			'kemampuan',
		...
		*/
		$model = new Cms_Model_FasilitasLabuhUdara();

...
class Cms_FasilitasListrikController extends App_CrudController
{
	...
	public function dataapiAction()
	{
		...
		/**/
		$dt = new Cms_Model_Datatables_FasJarListrik($this->_request->getParams());
		echo $dt->result();
		/**/
	}
	...
	{
		$this->_add(null, 'index', 'Cms_Model_FasJarListrik');
	}
	
	public function editAction()
	{
		$this->_edit(null, 'index', 'Cms_Model_FasJarListrik');
	}
	
	public function delAction()
	{
		$this->_del(null, 'index', 'Cms_Model_FasJarListrik');
	}
	...
	{
		$obj = new Cms_Model_FasJarListrik(null,$this->_request->getParam('id'));
		$this->view->obj = $obj;
	}
	...
	public function importAction()
	{
		...
		*/
		$importer = new Cms_Model_Import_Excel('master.fasilitas_jaringan_listrik', array(
			'idpangkalan', 'jenis', 'merk',
			'jumlah_unit',
			'voltase',
			'jenis_genset',
			'ampere',
		...
		*/
		$model = new Cms_Model_FasJarListrik();

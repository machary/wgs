<?php
class Cms_RumahController extends App_CrudController
{
    ...
    public function dataapiAction()
    {
        ...
        /**/
        $dt = new Cms_Model_Datatables_Rumah($this->_request->getParams());
        echo $dt->result();
    }

    public function addAction()
    {
        $this->_add(null, 'index', 'Cms_Model_Rumah');
    }

    public function editAction()
    {
        $this->_edit(null, 'index', 'Cms_Model_Rumah');
    }

    public function delAction()
    {
        $this->_del(null, 'index', 'Cms_Model_Rumah');
    }

	public function viewAction()
	{
		$obj = new Cms_Model_FasRumah(null,$this->_request->getParam('id'));
		$this->view->obj = $obj;
	}
	...
	public function importAction()
	{
		...
		*/
		$importer = new Cms_Model_Import_Excel('master.fasilitas_rumah', array(
			'idpangkalan', 'tipe_rumah', 'jenis_rumah',
			'jabatan',
			'jumlah_unit',
		));
		/*

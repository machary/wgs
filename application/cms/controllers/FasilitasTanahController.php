...
class Cms_FasilitasTanahController extends App_CrudController
{
	...
	public function dataapiAction()
	{
		...
		/**/
		$dt = new Cms_Model_Datatables_FasTanah($this->_request->getParams());
		echo $dt->result();
		/**/
	}
	...
	{
		$this->_add(null, 'index', 'Cms_Model_FasTanah');
	}
	
	public function editAction()
	{
		$this->_edit(null, 'index', 'Cms_Model_FasTanah');
	}
	
	public function delAction()
	{
		$this->_del(null, 'index', 'Cms_Model_FasTanah');
	}

    public function viewAction()
    {
        $obj = new Cms_Model_FasTanah(null,$this->_request->getParam('id'));
        $this->view->obj = $obj;
    }
	...
	public function importAction()
	{
		...
		*/
		$importer = new Cms_Model_Import_Excel('master.fasilitas_tanah', array(
			'idpangkalan', 'status_tanah', 'jumlah', 'total_luas'
		));
		/*

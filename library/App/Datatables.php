...
abstract class App_Datatables
{
	...
	/**
	 * The complete parameters thrown at constructor
	 * @var array
	 */
	protected $_params;
	/**
	 ...
	 * berdasarkan $this->_search dan $this->_searchable
	...
	protected function _search($query)
	{
		...
		if ($this->_search) {
			foreach ($this->_searchable as $col => $isSearchable) {
				if ($isSearchable) {
					$query->orWhere('"'.$col.'" ilike ?', "%{$this->_search}%");
				}
			}
		}
	}
